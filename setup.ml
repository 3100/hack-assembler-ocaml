...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd008773ecd1795f2de98bdabc83c075) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/3100/hack-assembler-ocaml";
          bugreports = None;
          synopsis = "Hack assembler written in OCaml";
          description =
            Some [OASISText.Para "a Hack assembler for nand2tetris course."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
     ...
     oasis_digest = Some "w\139\023\146\245]\173\146!\0078\202\199\197\170Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
